...
from modules import AwsHealth, CloudWatchAlarm, GuardDutyFinding
...
def get_slack_message_payload(
    ...
    if "AlarmName" in message:
        notification = CloudWatchAlarm.format(message=message, region=region)
        ...
        notification = AwsHealth.format(message=message, region=message["region"])
        attachment = notification
